...
class ExecuteMaster:
    ...
    def doExecution(self, executor, step, job):
        ...
        try:
            ...
            executor.report.addError(executor.step._internal_name, ex.code, "WMAgentStepExecutionError", str(ex))
            error = True
        except Exception as ex:
            ...
            executor.report.addError(executor.step._internal_name, 99109, "WMAgentStepExecutionError", str(ex))
            error = True
