...
class GFAL2Impl(StageOutImpl):
    ...
    def adjustSetup(self, auth_method=None):
        ...
        if auth_method == "X509":
            ...
            self.setups = "env -i BEARER_TOKEN_FILE=$BEARER_TOKEN_FILE BEARER_TOKEN=$(cat $BEARER_TOKEN_FILE) JOBSTARTDIR=$JOBSTARTDIR bash -c 'echo; echo HELLO THERE; echo; echo \"BEARER_TOKEN: $BEARER_TOKEN\"; echo \"BEARER_TOKEN_FILE: $BEARER_TOKEN_FILE\"; echo \"X509_USER_PROXY: $X509_USER_PROXY\"; {}'"
        else:
