...
def updateCache():
    try:
        print("This worked")
        wmstatsDB = WMStatsReader("https://cmsweb-test9.cern.ch/couchdb/wmstats", reqmgrdb_url = "https://cmsweb-test9.cern.ch/couchdb/reqmgr_workload_cache", reqdbCouchApp="ReqMgr", logger=self.logger)
