...
class DBFactory(object):
    ...
    def __init__(self, logger, dburl=None, options={}):
        ...
        if 'engine_parameters' in list(options.keys()):
        ...
        if dburl:
            ...
            """
            hostjoin = ''
            if 'dialect' in list(options.keys()):
