...
MySQL implementation of BossLite.RunningJob.LoadByParameters
"""
...
class LoadByParameters(DBFormatter):
    ...
    def format(self, res):
        ...
        for entry in form:
            ...
            result['storage']               = entry['storage']
            result['lfn']                   = entry['lfn']
    ...
    def execute(self, taskID, jobID, submission, conn = None, transaction = False):
        ...
        binds = {'jobid': jobID, 'taskid': taskID, 'submission': submission}
