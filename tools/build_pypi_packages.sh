...
PACKAGES="wmagent wmagent_devtools wmcore reqmon reqmgr2 global_workqueue acdcserver
          reqmgr2ms_unmerged reqmgr2ms_output reqmgr2ms_rulecleaner reqmgr2ms_transferor reqmgr2ms_monitor"
