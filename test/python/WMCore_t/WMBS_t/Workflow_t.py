...
class WorkflowTest(unittest.TestCase):
    ...
    def testCreateDeleteExists(self):
        ...
        testWorkflow = Workflow(spec = "spec.xml", owner = "Simon",
                                name = "wf001", task='Test', type="ReReco")
    ...
    def testLoad(self):
        ...
        self.assertTrue((testWorkflowA.id == testWorkflowB.id) and
                        ...
                        (testWorkflowA.type == testWorkflowB.type) and
        ...
        self.assertTrue((testWorkflowA.id == testWorkflowC.id) and
                        ...
                        (testWorkflowA.type == testWorkflowC.type) and                        
        ...
        self.assertTrue((testWorkflowA.id == testWorkflowD.id) and
                        ...
                        (testWorkflowA.type == testWorkflowD.type) and                        
