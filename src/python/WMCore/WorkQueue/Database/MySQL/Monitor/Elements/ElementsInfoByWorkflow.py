"""
WMCore/WorkQueue/Database/MySQL/Monitor/ElementsInfoByWorkflow.py
...
class ElementsInfoByWorkflow(DBFormatter):
    """
    ...
    sql = """SELECT we.id as id, ws.name as spec_name, wt.name as task_name, 
                    ...
                    priority, parent_flag, status, subscription_id, team_name,
                    events_written, files_processed,
                    percent_complete, percent_success, insert_time, update_time
             FROM wq_element we
