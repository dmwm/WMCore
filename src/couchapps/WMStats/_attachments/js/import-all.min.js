if (WMStats.Globals.VARIANT == "tier1") {
    ...
    WMStats.Globals.importScripts(["js/minified/import-all-t1.min.js"])
} else if (WMStats.Globals.VARIANT == "tier0") {
    //import tie0 specific table
    WMStats.Globals.importScripts(["js/minified/import-all-t0.min.js"])
} else if (WMStats.Globals.VARIANT == "analysis") {
    //import analysis specific table
    WMStats.Globals.importScripts(["js/minified/import-all-analysis.min.js"])
} 