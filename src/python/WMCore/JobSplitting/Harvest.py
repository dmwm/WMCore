...
class Harvest(JobFactory):
    ...
    def createJobsLocationWise(self, fileset, endOfRun, dqmHarvestUnit, goodRunList):
        """
        _createJobsLocationWise_

        Sort files and runs according to their location and then calls the
        proper method - based on the dqmHarvestUnit - to create the harvesting
        job in a location basis.
        """
