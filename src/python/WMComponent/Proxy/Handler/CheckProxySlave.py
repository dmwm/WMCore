...
class CheckProxySlave(ThreadSlave):
    ...
    def __call__(self, parameters):
        ...
        type,payload = self.component.proxies[parameters['payload']]['queueIn'].retrieve()
        ...
        msg = {'name':'CheckProxy','payload':parameters['payload'],'delay':self.component.config.Proxy.contactIn}
        myThread.transaction.begin()
