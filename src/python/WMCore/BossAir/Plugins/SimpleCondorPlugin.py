...
class SimpleCondorPlugin(BasePlugin):
    ...
    def __init__(self, config):
        ...
        self.rel_microarchs = self.tc.defaultMicroArchVersionNumberByRelease()
    ...
    def getJobParameters(self, jobList):
        ...
        for job in jobList:
            ...
            if 'X86_64' not in requiredArchs.split(","):
                ...
                minMicroArch = self.tc.getGreaterMicroarchVersionNumber(cmsswVersions, rel_microarchs=self.rel_microarchs)
