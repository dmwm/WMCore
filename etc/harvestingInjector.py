...
parser.add_option("-d", "--dataset", dest="InputDataset",
                  action="store", help="Dataset to harvest",
                  metavar="DATASET")
parser.add_option("-R", "--run", dest="RunWhitelist", type=comma_separated_list,
                  action="store", help="Comma separated list of runs",
                  metavar="RUN1,RUN2", default=[])
parser.add_option("-r", "--release", dest="CMSSWVersion",
...
parser.add_option("-s", "--scenario", dest="Scenario",
                  ...
                  metavar="SCENARIO")
parser.add_option("-t", "--global-tag", dest="GlobalTag",
                  action="store", help="Conditions global tag",
                  metavar="GLOBALTAG")
parser.add_option("-f", "--reference", dest="RefHistogram",
