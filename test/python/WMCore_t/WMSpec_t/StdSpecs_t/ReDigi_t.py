...
class ReDigiTest(EmulatedUnitTestCase):
    ...
    def testDependentReDigi(self):
        ...
        self.assertTrue("RAWDEBUGoutput" in list(stepOneWorkflow.outputMap.keys()),
                        "Error: Step one missing output module.")
        ...
        self.assertTrue("Merged" in list(stepOneMergeWorkflow.outputMap.keys()),
        ...
        self.assertTrue("RECODEBUGoutput" in list(stepTwoWorkflow.outputMap.keys()),
                        "Error: Step two missing output module.")
        self.assertTrue("DQMoutput" in list(stepTwoWorkflow.outputMap.keys()),
                        "Error: Step two missing output module.")
        ...
        self.assertTrue("Merged" in list(stepTwoMergeRECOWorkflow.outputMap.keys()),
        ...
        self.assertTrue("Merged" in list(stepTwoMergeDQMWorkflow.outputMap.keys()),
                        "Error: Step two merge missing output module.")
        ...
        self.assertTrue("aodOutputModule" in list(stepThreeWorkflow.outputMap.keys()),
        ...
        self.assertTrue("Merged" in list(stepThreeMergeWorkflow.outputMap.keys()),
    ...
    def verifyKeepAOD(self):
        ...
        stepTwoWorkflow = Workflow(spec="somespec", name="TestWorkload",
                                   task="/TestWorkload/StepOneProc")
        stepTwoWorkflow.load()
        self.assertTrue("aodOutputModule" in list(stepTwoWorkflow.outputMap.keys()),
                        "Error: Step two missing output module.")
        self.assertEqual(stepTwoWorkflow.outputMap["logArchive"][0]["merged_output_fileset"].id,
                         stepTwoLogArchiveFileset.id,
                         "Error: logArchive fileset is wrong.")
        ...
        self.assertTrue("Merged" in list(stepTwoMergeAODWorkflow.outputMap.keys()),
                        "Error: Step two merge missing output module.")
