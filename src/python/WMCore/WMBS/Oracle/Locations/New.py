...
class New(NewLocationMySQL):    
    sql = """INSERT INTO wmbs_location (id, site_name, se_name, ce_name, job_slots) SELECT
             wmbs_location_SEQ.nextval, :location, :sename, :cename, :slots AS site_name FROM DUAL
