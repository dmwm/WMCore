...
#./quality.sh $WMCOREBASE/src/python/WMCore/Database/DBFormatter.py
#mv codeQuality.txt qualityDBFormatter.txt
...
#./quality.sh $WMCOREBASE/test/python/WMCore/Database_t/DBFormatter_t.py
#mv codeQuality.txt qualityDBFormatter_t.txt
