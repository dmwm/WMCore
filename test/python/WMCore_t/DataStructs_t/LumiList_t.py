...
class LumiListTest(unittest.TestCase):
    ...
    def testSubtract(self):
        ...
        blumis = {'1' : list(range(1,6)) + list(range(12,13)) + list(range(16,30)) + list(range(40,50)) + list(range(33,36)),
                  '2' : list(range(10,35)),
                  '3' : list(range(10,15)) + list(range(35,40)) + list(range(45,51)) + list(range(59,70)),
                 }
        clumis = {'1' : list(range(1,6)) + list(range(12,13)) + list(range(16,30)) + list(range(40,50)) + list(range(33,36)),
                  '2' : list(range(10,35)),
                 }
    ...
    def testOr(self):
        ...
        blumis = {'1' : list(range(1,6)) + list(range(12,13)) + list(range(16,30)) + list(range(40,50)) + list(range(39,80)),
                  '2' : list(range(10,35)),
                  '3' : list(range(10,15)) + list(range(35,40)) + list(range(45,51)) + list(range(59,70)),
                 }
        clumis = {'1' : list(range(1,6)) + list(range(12,13)) + list(range(16,30)) + list(range(40,50)) + list(range(39,80)),
                  '2' : list(range(10,35)),
                 }
        result = {'1' : list(range(2,20)) + list(range(31,39)) + list(range(45,49)) + list(range(1,6)) + list(range(12,13)) + list(range(16,30)) + list(range(40,50)) + list(range(39,80)),
                  '2' : list(range(6,20)) + list(range(30,40)) + list(range(10,35)),
                  '3' : list(range(10,20)) + list(range(30,40)) + list(range(50,60)) + list(range(10,15)) + list(range(35,40)) + list(range(45,51)) + list(range(59,70)),
                 }
        a = LumiList(runsAndLumis = alumis)
        b = LumiList(runsAndLumis = blumis)
    ...
    def testAnd(self):
        ...
        blumis = {'1' : list(range(1,6)) + list(range(12,13)) + list(range(16,25)) + list(range(25,40)) + list(range(40,50)) + list(range(33,36)),
                  '2' : list(range(10,35)),
                  '3' : list(range(10,15)) + list(range(35,40)) + list(range(45,51)) + list(range(59,70)),
                  '5' : list(range(1,100)),
                 }
        result = {'1' : list(range(2,6)) + list(range(12,13)) + list(range(16,20)) + list(range(31,39)) + list(range(45,49)),
