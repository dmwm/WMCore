...
__CHEETAH_genTime__ = 1223857868.2518561
__CHEETAH_genTimestamp__ = 'Sun Oct 12 20:31:08 2008'
__CHEETAH_src__ = 'Templates/tmpl/templateTop.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Oct 12 20:30:59 2008'
...
<body onload="''')
        _v = VFFSL(SL,"onload",True) # '$onload' on line 27, col 15
        if _v is not None: write(_filter(_v, rawExpr='$onload')) # from line 27, col 15.
        write('''" id="content">
