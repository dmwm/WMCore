...
(function(vm) {
    ...
    vm.Resubmission = (function (){
        ...
        resubmission.formatResubmissionData = function(reqMgrRequest) {
            ...
            summary.Teams = requestInfo.Teams;
            summary.AcquisitionEra = requestInfo.AcquisitionEra;
            summary.GlobalTag = requestInfo.GlobalTag;
            summary.ScramArch = requestInfo.ScramArch;
            summary.SiteWhitelist = requestInfo.SiteWhitelist;
            summary.SiteBlacklist = requestInfo.SiteBlacklist;
            ...
            summary.TrustPUSitelists = requestInfo.TrustPUSitelists;
