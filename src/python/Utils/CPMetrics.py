...
Author     : Valentin Kuznetsov <vkuznet AT gmail dot com>
             Alan Malta Rodrigues <alanmalta AT gmail dot com>
Description: This module provides functions to flatten CherryPy stats
...
def promMetrics(cpStats, exporterName):
    ...
    for key, val in metrics.iteritems():
        ...
        if isinstance(val, list):
            ...
            for wdict in val:
                entries = []
                for kkk, vvv in wdict.iteritems():
