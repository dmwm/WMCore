...
WMStats.createTable = function(data, containerDiv) {
    /*
     * data is data object with following structure
     * data = {colDefs: .., content}
     */
    var dataSource = new YAHOO.util.LocalDataSource(data);
    var dataTable = new YAHOO.widget.DataTable(containerDiv,
...
WMStats.createDataSource = function (dataUrl, dataSchema, type) {
...
WMStats.createDefaultTableDef = function (tableDef) {
...
WMStats.createDefaultTableConfig = function(sortBy) {
...
WMStats.createDataTable = function (container, dataSource, columnDefs, 
