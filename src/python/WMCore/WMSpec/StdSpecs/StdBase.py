    ...
    def getWorkloadArguments():
        ...
        arguments = {"RequestPriority": {"default" : 0, "type" : int,
                     ...
                     "MaxMergeEvents" : {"default" : 100000, "type" : int,
                                         "validate" : lambda x : x > 0,
                                         "attr" : "maxMergeEvents"},
                     "ValidStatus" : {"default" : "PRODUCTION", "attr" : "validStatus"},
                     ...
                     "DashboardPort" : {"default" : 8884, "type" : int,
                                        "validate" : lambda x : x > 0,
                                        "attr" : "dashboardPort"},
                     "OverrideCatalog" : {"default" : None, "null" : True, "attr" : "overrideCatalog"},
                     "RunNumber" : {"default" : 0, "type" : int, "attr" : "runNumber"},
