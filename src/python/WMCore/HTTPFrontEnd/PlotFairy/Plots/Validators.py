...
class MarkerBase(ElementBase):
    def __init__(self,element_name,default='o'):
        ElementBase.__init__(self,element_name,basestring,True,default)
    def extract(self,input):
        if self.element_name in input:
...
class FontSize(ElementBase):
    def __init__(self,element_name,default=None):
        ElementBase.__init__(self,element_name,(basestring,int),True,default)
    def extract(self,input):
        if self.element_name in input:
            val = input[self.element_name]
